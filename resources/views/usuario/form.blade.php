...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Formulario de usuarios') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ action('UsuarioController@create') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="estrato" type="number" class="form-control @error('estrato') is-invalid @enderror" name="estrato" value="{{ old('documento') }}" required >
                                @error('estrato')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
